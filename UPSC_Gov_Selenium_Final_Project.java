...
public class UPSC_Gov_Project {
	...
	static WebDriver driver ; 
 	...
 	public static void main(String[] args) throws InterruptedException, IOException {
	     ...
	     System.setProperty("webdriver.chrome.driver", "C:\\users\\\\Admin\\Desktop\\SeleniumJar\\chromedriver_win32\\chromedriver.exe");
		...
		/*Upscmodules um=new Upscmodules();
		um.Recuritrules();
		um.Recuritment();*/
    ...
    //************************* "Public Disclosure of marks & other details of non-recommended willing candidates" ***********************************        
	  ...
	  //*************************Recruitment Requisition Tab in Recuritment Drop down*******************
	    	...
	    	driver.findElement(By.xpath("//input[@id='edit-field-name-of-post-vaccancy-value']")).sendKeys("421 Posts of Enforcement Officer - Accounts Officer, EPFO");
	    	driver.findElement(By.xpath("//button[@id='edit-submit-recruitment']")).click();
	    	System.out.println(driver.findElement(By.xpath("//p[contains(text(),'Currently no data to display.')]")).getText());
	    	driver.findElement(By.xpath("//button[@id='edit-reset']")).click();
	    	Thread.sleep(2000);
	    	driver.findElement(By.xpath("//a[contains(text(),'View Archives >>')]")).click();
	    	...
	    	driver.findElement(By.xpath("//input[@id='edit-field-name-of-post-vaccancy-value']")).sendKeys("421 Posts of Enforcement Officer - Accounts Officer, EPFO");
	    	driver.findElement(By.xpath("//button[@id='edit-submit-recruitment']")).click();
	    	System.out.println(driver.findElement(By.xpath("//b[contains(text(),'There is no Current Result Detail to show.')]")).getText());
	    	driver.findElement(By.xpath("//button[@id='edit-reset']")).click();
	    	Thread.sleep(2000);
	    	driver.findElement(By.xpath("//a[contains(text(),'View Archives >>')]")).click();
	    	...
	    	driver.findElement(By.xpath("//input[@id='edit-field-name-of-post-vaccancy-value']")).sendKeys("421 Posts of Enforcement Officer - Accounts Officer, EPFO");
	    	driver.findElement(By.xpath("//button[@id='edit-submit-recruitment']")).click();
	    	System.out.println(driver.findElement(By.xpath("//b[contains(text(),'There is no Current Answer Key to show.')]")).getText());
	    	driver.findElement(By.xpath("//button[@id='edit-reset']")).click();
	    	Thread.sleep(2000);
	    	driver.findElement(By.xpath("//a[contains(text(),'View Archives >>')]")).click();
	    	driver.findElement(By.xpath("//input[@id='edit-field-advertisement-number-value']")).sendKeys("19 - 2018");
	...
	public void Recuritrules() throws InterruptedException {
		...
		driver.switchTo().window(child_window);
		Thread.sleep(2000);
		// To check the Pdf link 1 in recruitment rules- Forms and downloads  page //New window will open for pdf link
		...
		// To check the Pdf link 2 in recruitment rules- Forms and downloads  page //New window will open for pdf link
		...
		// To check the Pdf link 3 in recruitment rules- Forms and downloads  page //New window will open for pdf link
		driver.findElement(By.xpath("//body/section[2]/div[1]/div[2]/div[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[3]/span[1]/ul[1]/ul[1]/ul[1]/ul[1]/li[1]/a[1]")).click();
		Thread.sleep(2000);
		//To switch back to Recruitment page
		driver.switchTo().window(child_window);
		Thread.sleep(2000);
		// To check the Pdf link 4 in recruitment rules- Forms and downloads  page //New window will open for pdf link
		driver.findElement(By.xpath("//body/section[2]/div[1]/div[2]/div[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[3]/span[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/li[1]/a[1]")).click();
		Thread.sleep(2000);
		//To switch back to Recruitment page
		driver.switchTo().window(child_window);
		Thread.sleep(2000);
		
		// To check the Pdf link 5 in recruitment rules- Forms and downloads  page //New window will open for pdf link
		driver.findElement(By.xpath("//body/section[2]/div[1]/div[2]/div[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[3]/span[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/li[1]/a[1] ")).click();
		Thread.sleep(2000);
		//To switch back to Recruitment page
		driver.switchTo().window(child_window);
		Thread.sleep(2000);
		
		// To check the Pdf link 6 in recruitment rules- Forms and downloads  page //New window will open for pdf link
		driver.findElement(By.xpath("//body/section[2]/div[1]/div[2]/div[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[3]/span[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/li[1]/a[1]")).click();
		Thread.sleep(2000);
		//To switch back to Recruitment page
		driver.switchTo().window(child_window);
		Thread.sleep(2000);

		// To check the Pdf link 7 in recruitment rules- Forms and downloads  page //New window will open for pdf link
		driver.findElement(By.xpath("//body/section[2]/div[1]/div[2]/div[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[3]/span[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/ul[1]/li[1]/a[1]")).click();
		Thread.sleep(2000);
		//To switch back to Recruitment page
		driver.switchTo().window(child_window);
		Thread.sleep(2000);
	...
	public void uniont() throws InterruptedException {
		...
		Set<String> windows24=driver.getWindowHandles();
		ArrayList <String> tab24=new ArrayList(windows24);
		driver.switchTo().window(tab24.get(2));
		driver.close();
		driver.switchTo().window(tab24.get(1));
	    ...
	    public void others() throws InterruptedException{
	    	driver.findElement(By.xpath("//body/section[2]/div[1]/div[1]/div[1]/section[1]/div[1]/ul[1]/li[4]/a[1]")).click();
	    	System.out.println("Title of page: "+driver.getTitle());
	    	driver.findElement(By.xpath("//a[contains(text(),'Recruitment Rules')]")).click();
	    	System.out.println("Title of page: "+driver.getTitle());
	    	...
	    	/*Set <String> windows3=d.getWindowHandles();
	    	ArrayList <String> tab3=new ArrayList(windows3);
